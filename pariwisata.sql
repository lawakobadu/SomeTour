...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 24 Nov 2021 pada 14.10
...
(23, 1, 'Pulau Setan', 'maritim', 'Pulau Setan memiliki keindahan alam yang tak kalah mempesona dengan wisata lainnya. Pulau Setan adalah salah satu tempat di wilayah Pesisir Pantai yang sangat banyak dikunjungi oleh wisatawan dibandingkan dengan tempat wisata lainnya. Di pantai ini Anda tidak akan hanya melihat pemandangan menawan, namun Anda juga dapat melihat keindahan alam lain berupa deretan nelayan yang berjejeran di pantai.', 'maritim-5', 'Kecamatan Koto XI Tarusan, Pesisir Selatan, Sumatera Barat', '24 jam', 1),
(24, 1, 'Pantai Salido', 'maritim', 'Pesisir Selatan. Pantai ini selalu menjadi destinasi wisata yang tak pernah sepi oleh pengunjung baik dari dalam negeri maupun luar negeri. Dengan mengunjungi pantai sebagai salah satu destinasi secara tidak langsung akan membuat Anda tenang dan damai karena suasana di sekitar pantai yang begitu sejuk.', 'maritim-6', 'Salido, Kec. IV Jurai, Kab. Pesisir Selatan', 'Setiap hari pukul 06.00-19.00 WIB', 1),
(25, 1, 'Wisata Mandeh', 'maritim', 'Wisata yang satu ini telah berdiri sejak tahun 2015 dan selalu saja ramai dikunjungi oleh wisatawan. Pemandangan yang berada di sekitar Mandeh sangat menawan sehingga membuat para wisatawan terlena dan ingin kembali lagi untuk berlibur. Di tempat wisata Mandeh ini Anda dapat menikmati keindahan dari lautan yang sangat menakjubkan. Tak hanya itu, di sekitar sisi pulau akan didapati banyak batuan karang yang memiliki ukuran tidak terlalu besar.', 'maritim-7', 'Mandeh, Kec. Koto XI Tarusan, Kab. Pesisir Selatan', 'Setiap hari 06.00-19.00 WIB', 1),
...
(46, 1, 'Lobang Jepang', 'sejarah', 'Tempat ini adalah sebuah lubang dengan panjang 1.470 meter. Lokasinya berada tidak jauh dari Ngarai Sianok, yaitu sekitar 40 meter di bawahnya. Yang unik dari Lobang Jepang adalah terdapat terowongan berjumlah 21 buah. Fungsi ke-21 terowongan itu bermacam-macam, sebagai tempat tinggal, ruang tahanan, hingga ruang penyiksaan.', 'sejarah-10', 'Jl. Panorama, Bukit Cangang Kayu Ramang, Guguk Panjang, Bukittinggi', 'Senin-Minggu : 08.00 - 18.00 WIB', 1),
...
(49, 1, 'Museum Bung Hatta', 'sejarah', 'Museum ini dahulunya adalah rumah yang menjadi rumah kelahiran Bung Hatta. Karena jasanya, rumah dari salah satu tokoh penting bangsa ini dirawat dan dijadikan sebuah museum. Kawasan museum sendiri luasnya mencapai 1.000 m2. Keseluruhan aset berupa tanah dan rumah  ditangani langsung oleh Dinas Pariwisata, Seni, dan Budaya kota Bukittinggi.', 'sejarah-13', 'Jl. Soekarno Hatta No.37, Campago Ipuh, Mandiangin Koto Selayan, Kota Bukittinggi.', 'Senin-Minggu : 09.00 - 16.00 WIB', 1),
(50, 1, 'Candi Padang Roco', 'sejarah', 'Candi ini adalah bangunan peninggalan kerajaan Melayu yang dijadikan sebagai tempat ibadah para raja. Candi Padang Roco ini memiliki 4 candi, namun baru ada 3 candi yang sudah dipugar. Candi Padang Roco I, tingginya 118 meter dari permukaan laut. Candi Padang Roco II, tingginya 113 meter dari permukaan laut dan memiliki tangga dengan lebar 3,55 meter di empat sisinya. Candi Padang Roco III, tingginya 123 meter dari permukaan laut, berbentuk persegi Panjang dan bagian tengahnya merupakan ruang kosong.', 'sejarah-14', 'Jorong Padang Roco Nagari Siguntur, Kecamatan Sitiung, Kabupaten Dharmasraya, Sumatera Barat.', 'Senin-Minggu : 08.00-18.00 WIB', 1),
(51, 1, 'Rumah Gadang Siguntur', 'sejarah', 'Rumah Gadang Siguntur adalah salah satu peninggalan dari kerajaan Siguntur, yaitu kerajaan yang terbentuk setelah runtuhnya Kerajaan Melayu Dharmasraya. Rumah Gadang ini dahulunya adalah pusat pemerintahan kerajaan. Dan kini, tempat ini juga masih menjadi pusat pertemuan para pewaris tahta kerajaan Siguntur. Jika ke tempat ini, kita dapat beramah tamah dan mengeksplor cerita Bersama pewaris tahta kerajaan yang masih hidup di masa kini.', 'sejarah-15', 'Siguntur, Dharmasraya', 'Senin-Jumat : 08.00-18.00 WIB', 1),
...
--
ALTER TABLE `objek_wisata`
  MODIFY `kode_wisata` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55;
