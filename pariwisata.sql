...
(24, 1, 'Pantai Salido', 'maritim,', 'Pantai Salido adalah salah satu pantai yang terletak di kecamatan IV Jurai, Pesisir Selatan. Pantai ini selalu menjadi destinasi wisata yang tak pernah sepi oleh pengunjung baik dari dalam negeri maupun luar negeri. Dengan mengunjungi pantai sebagai salah satu destinasi secara tidak langsung akan membuat Anda tenang dan damai karena suasana di sekitar pantai yang begitu sejuk.', 'mariim-6', 'Salido, Kec. IV Jurai, Kab. Pesisir Selatan', 'Setiap hari 06.00-19.00 WIB'),
...
(27, 1, 'Pantai Pamutusan', 'maritim', 'Salah satu pantai yang tak kalah menariknya dengan lokasi wisata lainnya adalah pulau Pamutusan. Pulau yang sangat indah dan menawan ini dapat dijadikan sebagai salah satu destinasi yang wajb dikunjungi saat berada di Pesisir Selatan. Selain itu, pemandangan yang eksotis di sekitar menjadi salah satu spot terbaik untuk mendapatkan hasil foto yang keren. Pulau ini biasa menjadi alternative wisata bahari saat berlibur Bersama keluarga ataupun teman-teman. Pantai Pamutusan ini terletak di Desa Sungai', 'maritim-9', ' Sungai Pinang, Kec. Koto XI Tarusan, Kab. Pesisir Selatan', '24 jam'),
