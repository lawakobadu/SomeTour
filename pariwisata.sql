...
(24, 1, 'Pantai Salido', 'maritim', 'Pesisir Selatan. Pantai ini selalu menjadi destinasi wisata yang tak pernah sepi oleh pengunjung baik dari dalam negeri maupun luar negeri. Dengan mengunjungi pantai sebagai salah satu destinasi secara tidak langsung akan membuat Anda tenang dan damai karena suasana di sekitar pantai yang begitu sejuk.', 'maritim-6', 'Salido, Kec. IV Jurai, Kab. Pesisir Selatan', 'Setiap hari pukul 06.00-19.00 WIB'),
